...
public class YpAuthScopePhoneNumberHttpRequest extends YpAbstractAuthScopeHttpRequest<String> {

    public YpAuthScopePhoneNumberHttpRequest(@NotNull String url,
    ...
    protected String onOk(String input, YpServiceResponse response) {
        return convertJsonToObject(response.getResponseBody(), Response.class).getPhone();
    }
